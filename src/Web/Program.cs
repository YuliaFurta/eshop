...
builder.Services.AddDbContext<CatalogContext>(opt => opt.UseInMemoryDatabase("CatalogContext"));



// Add Identity DbContext

builder.Services.AddDbContext<AppIdentityDbContext>(opt => opt.UseInMemoryDatabase("AppIdentityDbContext"));
// use real database
...
var appSettings = builder.Configuration.GetSection(AppSettings.CONFIG_NAME);
builder.Services.Configure<AppSettings>(appSettings);

var storageConfig = builder.Configuration.GetSection("AzureStorageConfig");
builder.Services.Configure<AzureStorageConfig>(storageConfig);
